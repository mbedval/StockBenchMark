...
CACHE_DB_PATH = "data/cache/new_sectors_cache.db"
...
# 6 New Sectors with Tickers and Sub-sectors
SECTORS_DEFINITION = {
    "commodity_chemicals": {
        "title": "Commodity Chemicals",
        "html_name": "CommodityChemicals.html",
        "theme_color": "#0284c7", # Light Blue
        "constituents": {
            "TATACHEM.NS": "Soda Ash & Halogens",
            "GUJALKALI.NS": "Caustic Soda & Chlorine",
            "GHCL.NS": "Inorganic Chemicals",
            "DCW.NS": "Chlor-Alkali & Soda Ash",
            "CHEMCON.NS": "Oilwell Completion Chemicals"
        }
    },
    "diversified_chemicals": {
        "title": "Diversified Chemicals",
        "html_name": "DiversifiedChemicals.html",
        "theme_color": "#0f766e", # Teal
        "constituents": {
            "SRF.NS": "Fluorochemicals & Technical Textiles",
            "AARTIIND.NS": "Benzene Derivatives",
            "ATUL.NS": "Life Science & Specialty Chemicals",
            "DEEPAKNTR.NS": "Phenolics & Basic Chemicals",
            "DCMSRIND.NS": "Organic & Inorganic Chemicals"
        }
    },
    "speciality_chemicals": {
        "title": "Speciality Chemicals",
        "html_name": "SpecialityChemicals.html",
        "theme_color": "#be185d", # Rose Pink
        "constituents": {
            "FINEORG.NS": "Green Oleochemical Additives",
            "VINATIORG.NS": "Specialty Monomers & Aromatics",
            "NAVINFLUOR.NS": "Fluorospecialties & CRAMS",
            "CLEAN.NS": "Novel Catalytic Green Chemistries",
            "FLUOROCHEM.NS": "Fluoropolymers & Specialty Gases"
        }
    },
    "real_estate": {
        "title": "Real Estate",
        "html_name": "RealEstate.html",
        "theme_color": "#a21caf", # Magenta
        "constituents": {
            "DLF.NS": "Residential & Commercial Development",
            "LODHA.NS": "Premium Housing Development",
            "GODREJPROP.NS": "Residential Suburbs & Townships",
            "OBEROIRLTY.NS": "Luxury Residential Real Estate",
            "PRESTIGE.NS": "Mixed-Use Retail & Residential",
            "PHOENIXLTD.NS": "Retail Malls & Mixed-Use Space"
        }
    },
    "power_infrastructure": {
        "title": "Power Infrastructure",
        "html_name": "PowerInfrastructure.html",
        "theme_color": "#b45309", # Amber
        "constituents": {
            "POWERGRID.NS": "State Power Transmission Grid",
            "NTPC.NS": "Thermal & Hydro Power Utilities",
            "NHPC.NS": "Hydro-Electric Power Generation",
            "SJVN.NS": "Hydro, Wind, and Solar Projects",
            "RECLTD.NS": "Infrastructure Power Lending",
            "PFC.NS": "Power Finance & Development"
        }
    },
    "renewables": {
        "title": "Renewables",
        "html_name": "Renewables.html",
        "theme_color": "#15803d", # Green
        "constituents": {
            "SUZLON.NS": "Wind Turbine Generator Systems",
            "IREDA.NS": "Renewable Project Finance Lending",
            "TATAPOWER.NS": "Integrated Solar, Wind & EV Infra",
            "ADANIGREEN.NS": "Solar & Wind IPP Operations",
            "KPIGREEN.NS": "Captive Solar Power Projects",
            "JSWENERGY.NS": "Renewable IPP Operations"
        }
    }
}

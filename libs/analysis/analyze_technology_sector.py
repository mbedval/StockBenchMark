...
CACHE_DB_PATH = "data/cache/technology_sector_cache.db"
...
# 7 Classified Technology & Electronics Sub-sectors
SECTORS_DEFINITION = {
    "it_services": {
        "title": "IT Services",
        "html_name": "ITServices.html",
        "theme_color": "#2563eb", # Blue
        "constituents": {
            "TCS.NS": "Global IT Outsourcing Services",
            "INFY.NS": "Enterprise Digital Transformation",
            "WIPRO.NS": "Global IT Consulting Services",
            "HCLTECH.NS": "Infrastructure Management & R&D Services",
            "TECHM.NS": "Telecom Software & IT Services",
            "LTIM.NS": "Midmarket Digital Services Integration"
        }
    },
    "saas": {
        "title": "SaaS",
        ...
        "constituents": {
            "ROUTEMOBILE.NS": "CPaaS Cloud Messaging Platform",
            "MAPMYINDIA.NS": "Location APIs & Geospatial SaaS",
            "AFFLE.NS": "Mobile Marketing & DSP SaaS Platforms",
            "EASEMYTRIP.NS": "Travel Aggregator & SaaS Booking Engines"
        }
    },
    "it_products": {
        "title": "IT Products",
        "html_name": "ITProducts.html",
        "theme_color": "#06b6d4", # Cyan
        "constituents": {
            "TATAELXSI.NS": "Automotive & Media Product Design",
            "KPITTECH.NS": "Automotive Software Products & Platforms",
            "QUICKHEAL.NS": "Cybersecurity Products & Antivirus Software",
            "RAMCOSYS.NS": "Enterprise Resource Planning (ERP) Products"
        }
    },
    "ems": {
        "title": "EMS",
        ...
        "constituents": {
            "KAYNES.NS": "Aerospace, Medical & Industrial EMS",
            "SYRMA.NS": "RFID, Magnetic & Specialized EMS",
            "CYIENTDLM.NS": "Aerospace & Medical System EMS",
            "AVALON.NS": "Cleanroom & Box-Build Specialized EMS",
            "CENTUM.NS": "Defence & Aerospace System EMS"
        }
    },
    "electronics": {
        "title": "Electronics",
        "html_name": "Electronics.html",
        "theme_color": "#ea580c", # Orange
        "constituents": {
            "DIXON.NS": "Consumer Electronics & Mobile Assemblies",
            "PGEL.NS": "Plastic Injection Molding & TV Assemblies",
            "HAVELLS.NS": "FMEG Electricals & Consumer Electronics",
            "POLYCAB.NS": "Wires, Cables & Consumer Electricals",
            "VGUARD.NS": "Stabilizers, Inverters & Kitchen Appliances"
        }
    },
    "semiconductor": {
        "title": "Semiconductor",
        "html_name": "Semiconductor.html",
        "theme_color": "#be185d", # Rose Pink
        "constituents": {
            "CGPOWER.NS": "OSAT / ATMP Assembly Plant",
            "KAYNES.NS": "Semiconductor OSAT plant setup",
            "SPEL.NS": "IC Assembly & Wafer Testing",
            "ASMTEC.NS": "Semiconductor Tooling & Engineering Services"
        }
    },
    "data_centres": {
        "title": "Data Centres",
        "html_name": "DataCentres.html",
        "theme_color": "#14b8a6", # Teal
        "constituents": {
            "NETWEB.NS": "HPC Servers & Storage Infrastructure",
            "TATACOMM.NS": "Data Center Hosting & Network Security",
            "HFCL.NS": "Data Center Fiber Optic Cabling Solutions",
            "SIEMENS.NS": "Data Center Power Supply & Chillers"
        }
    }
}

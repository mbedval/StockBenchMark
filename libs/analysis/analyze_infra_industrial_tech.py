...
CACHE_DB_PATH = "data/cache/infra_industrial_tech_cache.db"
...
# 6 New Infrastructure, Industrial, and Tech Sectors
SECTORS_DEFINITION = {
    "water_management": {
        "title": "Water Management",
        "html_name": "WaterManagement.html",
        "theme_color": "#0ea5e9", # Sky Blue
        "constituents": {
            "VATECHWABG.NS": "Desalination & Water Treatment",
            "IONEXCHANG.NS": "Industrial Water Purifier & Softener",
            "SHAKTIPUMP.NS": "Solar Pumps & Irrigation",
            "KIRLOSBROS.NS": "Water Infrastructure Pump Systems",
            "EMS.NS": "Sewerage & Waste Water Treatment"
        }
    },
    "plastic_products": {
        "title": "Plastic Products",
        "html_name": "PlasticProducts.html",
        "theme_color": "#d97706", # Orange Accent
        "constituents": {
            "SUPREMEIND.NS": "Industrial & Piping Plastics",
            "ASTRAL.NS": "CPVC & PVC Plumbing Pipes",
            "FINPIPE.NS": "Agricultural PVC Pipes & Fittings",
            "PRINCEPIPE.NS": "Piping & Sewerage Systems",
            "RESPONIND.NS": "PVC Sheets & Synthetic Leather"
        }
    },
    "cements": {
        "title": "Cements",
        "html_name": "Cements.html",
        "theme_color": "#4b5563", # Cool Gray
        "constituents": {
            "ULTRACEMCO.NS": "Grey & White Cement",
            "AMBUJACEM.NS": "Industrial Portland Pozzolana",
            "ACC.NS": "Ready-Mix Concrete & Blended Cements",
            "SHREECEM.NS": "Power Plant Backed Cements",
            "DALBHARAT.NS": "High Performance Infrastructural Cement"
        }
    },
    "communication_networking": {
        "title": "Communication and Networking",
        "html_name": "CommunicationNetworking.html",
        "theme_color": "#4f46e5", # Indigo
        "constituents": {
            "HFCL.NS": "Telecom Equipment & Fiber Optics",
            "TEJASNET.NS": "Networking Switches & Broadband Equipment",
            "ITI.NS": "Telecom Hardware Manufacturing",
            "ROUTEMOBILE.NS": "CPaaS Cloud Messaging",
            "TATACOMM.NS": "Global Managed Network Connectivity"
        }
    },
    "electronic_equipments": {
        "title": "Electronic Equipments",
        "html_name": "ElectronicEquipments.html",
        "theme_color": "#059669", # Emerald Green
        "constituents": {
            "HAVELLS.NS": "Industrial Switchgears & Cables",
            "POLYCAB.NS": "Wires & FMEG Manufacturing",
            "KEI.NS": "High Voltage Power Cables",
            "VGUARD.NS": "Stabilizers & Consumer Electronics",
            "DIXON.NS": "Electronics Manufacturing Services (EMS)"
        }
    },
    "software_services": {
        "title": "Software Services",
        "html_name": "SoftwareServices.html",

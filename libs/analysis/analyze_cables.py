...
CACHE_DB_PATH = "data/cache/cables_cache.db"
...
# Cables Sector Tickers and Sub-sectors
SECTORS_DEFINITION = {
    "cables": {
        "title": "Cables & Wires",
        "html_name": "Cables.html",
        "theme_color": "#ea580c", # Orange
        "constituents": {
            "POLYCAB.NS": "Power, Control & Communication Cables",
            "KEI.NS": "Extra High Voltage & Instrument Cables",
            "FINCABLES.NS": "Electrical & Communication Cables",
            "RRKABEL.NS": "House Wires & Industrial Cables",
            "PARAMOUNT.NS": "Telecom, Power & Railway Cables",
            "UNIVERSAL.NS": "Power & EHV Cables"
        }
    }
}
